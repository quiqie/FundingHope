...
class DonationsControllerTest < ActionController::TestCase
  ...
  test "should create donation" do
    assert_difference('Donation.count') do
      post :create, donation: { amount: @donation.amount, cause: @donation.cause, donor: @donation.donor, paid_out: @donation.paid_out }
    end
  ...
  test "should update donation" do
    put :update, id: @donation, donation: { amount: @donation.amount, cause: @donation.cause, donor: @donation.donor, paid_out: @donation.paid_out }
    assert_redirected_to donation_path(assigns(:donation))
  end
